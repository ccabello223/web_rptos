import { Component, Inject, OnInit, QueryList, ViewChild, ViewChildren, computed, inject } from '@angular/core';
...
import { Usuario, UsuariosMercadoLibre } from '../../interface/interface';
